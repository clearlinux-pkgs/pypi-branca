...
Source0  : https://files.pythonhosted.org/packages/4e/e7/9b78e6f307f8450396081413771c0c0ddccb9ac9e38cad83fbc128428353/branca-0.7.0.tar.gz
...
%prep
%setup -q -n branca-0.7.0
cd %{_builddir}/branca-0.7.0
pushd ..
cp -a branca-0.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699374383
